...
public class ChessNotationValidator {
    ...
    private static final String FEN_FORMAT =
            "^((([pnbrqkPNBRQK1-8]{1,8})\\/){7}([pnbrqkPNBRQK1-8]{1,8}))\\s([wb])\\s(-|[KQkq]{1,4})\\s(-|[a-h][36])\\s(\\d+)\\s(\\d+)$";

    // TODO
    public static StatusPair<FromFEN> validateFEN(String fen) {
