...
import static core.project.chess.application.controller.ws.ChessWSTest.Messages;
import static core.project.chess.application.controller.ws.ChessWSTest.sendMessage;
...
class PartnershipWSTest {
    ...
    void partnershipAcceptedWhenBothConnected() throws Exception {
        ...
        try (Session addresserSession = ContainerProvider
                ...
                .connectToServer(
                        ChessWSTest.WSClient.class, authUtils.serverURIWithToken(userSessionURI, addresserToken)
                );
